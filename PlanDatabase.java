...
public class PlanDatabase {
    private static final String TAG = "PlanDatabase";

    private static PlanDatabase database;
    public static String DATABASE_NAME = "todo.db";
    public static String TABLE_PLAN = "PLANN";
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            //테이블초기화
            String DROP_SQL = "drop table if exists " +TABLE_PLAN;
            ...
            //테이블 생성
            String CREATE_SQL = "create table " + TABLE_PLAN + "("
            ...
            //테이블의 인덱스 붙이기
            String CREATE_INDEX_SQL = "create index " + TABLE_PLAN + "_IDX ON " + TABLE_PLAN + "("
                    + "_id"
                    + ")";
            try{
